package com.qiushui1012.mod.qca.util;
...
public class TranslationsUtil {
    public static Map<String, String> getTranslations(String lang) {
        ...
        return getTranslationsWithLang(gson, lang).orElse(
            getTranslationsWithLang(gson, "en_us").orElse(Collections.emptyMap())
        );
    }

    private static Optional<Map<String, String>> getTranslationsWithLang(Gson gson, String lang) {
        return Optional.ofNullable(TranslationsUtil.class.getClassLoader().getResourceAsStream("assets/qca/lang/" + lang + ".json"))
